        ...
        return (
            <div>
                    <ReactMapGL
                        ...
                        >
                            {sensors.map(sensor => (
                            <Marker latitude={sensor.latitude} longitude={sensor.longitude} offsetLeft={-20} offsetTop={-10}>
                                <img src='../static/LOGO.png' width={'31px'} onClick={() => setPopUp(sensor.id)} />
                                {(popUp && popUp === sensor.id) ? (<PopUp setPopUp={setPopUp} />) : null}
                            </Marker>
                            ))}
